              ...
              >
                <Image
                  ...
                  className={`transition-transform duration-500 ${
                    index === 0
                      ? "object-contain scale-[1.8] sm:scale-[2.0] md:scale-[2.2] group-hover:scale-[2.0] md:group-hover:scale-[2.4]"
                      : index === 2
                      ? "object-cover scale-[1.1] group-hover:scale-[1.15]"
                      : index === 3
                      ? "object-contain group-hover:scale-105"
                      : "object-contain scale-[1.1] sm:scale-[1.15] md:scale-[1.2] group-hover:scale-[1.2] md:group-hover:scale-[1.3]"
                  }`}
                />
              </div>
