            ...
            <div className="prose prose-lg max-w-none">
              ...
              <section className="mb-12">
                ...
                <p className="text-gray-700 mb-4">
                  By placing a pre-order for SnapBoo, you agree to the following terms:
                </p>
                <ul className="list-disc pl-6 text-gray-700 space-y-2 mb-4">
                  ...
                  <li>We reserve the right to extend the manufacturing timeline if needed</li>
                </ul>
                ...
                <p className="text-gray-700 mb-4">
                  SnapBoo is a fan-made product and is not affiliated with, endorsed by, or 
                  sponsored by Pop Mart or Labubu™. All trademarks belong to their respective owners.
                </p>
                ...
                <ul className="list-disc pl-6 text-gray-700 space-y-2 mb-4">
                  ...
                  <li>We are not responsible for customs fees or import taxes</li>
                </ul>
                ...
                <ul className="list-disc pl-6 text-gray-700 space-y-2 mb-4">
                  ...
                  <li>We will replace defective items within 30 days of delivery</li>
                  <li>Refunds may be issued if we are unable to fulfill your order</li>
                  <li>Cancellations must be requested within 24 hours of ordering</li>
                </ul>
                ...
                <p className="text-gray-700 mb-4">
                  For questions or concerns, please contact us through our Shopify store.
                </p>
              </section>
              ...
              <section className="mb-12">
                ...
                <p className="text-gray-700 mb-4">
                  All payment processing is handled securely by Shopify. We do not store 
                  credit card information on our servers. Your personal data is encrypted 
                ...
                <ul className="list-disc pl-6 text-gray-700 space-y-2 mb-4">
                  ...
                  <li>Request deletion of your data (after order fulfillment)</li>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 text-sm">
                      This is my first time creating and selling a product. I'm doing my best 
                      to be transparent and fair. If you have any questions or concerns, please 
                      don't hesitate to reach out. I'm learning and appreciate your patience 
                      and support. 💜
                    </p>
                  </div>
                </div>
